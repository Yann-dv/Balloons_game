...
var localDifficulty = localStorage.getItem("difficulty_level");
var difficulty = parseInt(localDifficulty);
/* canvas */
...
function generateBubbles(amount) {
  ...
  for (var i = 0; i < amount; i++) {
    bubblesArray[i] = new Bubble(getRandomArbitrary(10, game_canva.width), 0, getRandomArbitrary(4, 30), speed = Math.random());
  }
}
...
function Bubble(x, y, rayon, speed) {
  ...
  this.fall = function () {
    ...
    this.draw();
    generateRectangle(); //console.log(speed);
  };
